...
- Reuse accepted 11.4 evidence-based provider/reconciliation boundaries without weakening 11.5.4 guarantees.
- Preserve Reservation.id, CONFIRMED, the public 15-minute hold, and lifecycle-email deferral.
```
