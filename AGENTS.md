...
- Final-F.R1 is documentation-only with explicit owner acceptance pending. Final-F.R2, Final-F.R3, Final-F.R4, Final-F.6 through Final-F.8, Final-G, Final-H, and Phase 13 must not begin automatically.
```
