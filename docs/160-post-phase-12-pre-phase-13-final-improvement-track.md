...
```text
Package: Final-F — Public WhatsApp Contact and Admin Notifications — Active under accepted Final-F.R3 architecture rebaseline
...
Final-F.4 — Guest inbound WhatsApp, safe Reservation matching and protected admin inbox — Completed and accepted on 2026-09-22 at 7912b233f5cc8b8aa726f17aeb30eaa7d15ae291
...
(documentation-only; completed and accepted on 2026-09-24 at be80af9b36f285c7669986e9c9b4d6676042f6f0)

Final-F.R4 —
WhatsApp backend/provider decommission
provider/schema cleanup
public floating WhatsApp contact
Implementation completed in repository; Local/Test cleanup migration applied; Hosted Test validation and explicit owner acceptance pending
...
Final-F.R4 implementation is completed in repository and Local/Test cleanup migration is applied, but R4 is not accepted yet; Hosted Test validation and explicit owner acceptance remain pending. Final-F.R5 and later remain Not started.
...
Final-F.R4 status — Implementation completed in repository; Local/Test cleanup migration applied; Hosted Test validation and explicit owner acceptance pending; record — docs/201-final-f-r4-whatsapp-backend-decommission-and-public-whatsapp-contact.md
