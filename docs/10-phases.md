...
Final-C.3 status: In progress — central pricing engine and public quote/pending-reservation integration prepared for validation
Final-C.3 record: docs/175-final-c-3-central-pricing-engine-and-public-pending-reservation-integration.md
Next planned subphase after Final-C.3 acceptance: Final-C.4 — Admin pricing-rule management — Not started
...
Next work: validate and accept Final-C.3 central pricing engine and public quote/pending-reservation integration, then begin Final-C.4 admin pricing-rule management only after acceptance; Phase 13 remains blocked until Final-H closes and the track is explicitly accepted
...
Status: **Active — Final-A and Final-B are completed and accepted; Final-C is in progress at Final-C.3; Phase 13 remains Not started**
...
Final-C Pricing rules: seasonal and length-of-stay — In progress
  ...
  Final-C.3 Central pricing engine and public quote/pending-reservation integration — In progress
