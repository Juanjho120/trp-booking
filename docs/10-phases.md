...
Next work: validate and accept Final-C.2 pricing persistence foundation/migration, then begin Final-C.3 only after acceptance; Phase 13 remains blocked until Final-H closes and the track is explicitly accepted
...
Status: **Active — Final-A and Final-B are completed and accepted; Final-C is in progress at Final-C.2; Phase 13 remains Not started**
...
Final-C Pricing rules: seasonal and length-of-stay — In progress
  ...
  Final-C.2 Pricing persistence foundation and migration — In progress; implementation base 030dec0d8681de18db746b9aae882cadd54db966; record: docs/174-final-c-2-pricing-persistence-foundation-and-migration.md
