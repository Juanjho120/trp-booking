...
Next work: validate and accept Final-B.5 from the accepted Final-B.4 head, then begin Final-B.6 — Integrated acceptance, regression and documentation closure; Phase 13 remains blocked until Final-H closes and the track is explicitly accepted
...
Status: **Active — Final-A is completed and accepted; Final-B is in progress at Final-B.5; Phase 13 remains Not started**
...
Final-B Admin external-calendar integrations — In progress
  ...
  Final-B.5 TRP outbound Copy URL / Rotate URL / export controls — Implementation prepared; pending Local/Test validation and owner acceptance; record: docs/171-final-b-5-trp-outbound-copy-rotation-and-export-controls.md
