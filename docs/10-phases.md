...
Next planned subphase: Final-B.5 — TRP outbound Copy URL / Rotate URL / export controls — Not started
...
Next work: validate and accept Final-B.4 from the accepted Final-B.3 head, then begin Final-B.5 — TRP outbound Copy URL / Rotate URL / export controls; Phase 13 remains blocked until Final-H closes and the track is explicitly accepted
...
Status: **Active — Final-A is completed and accepted; Final-B is in progress at Final-B.4; Phase 13 remains Not started**
...
Final-B Admin external-calendar integrations — In progress
  ...
  Final-B.4 Airbnb inbound configuration and operational actions — Implementation prepared; pending Local/Test validation and owner acceptance; record: docs/170-final-b-4-airbnb-inbound-configuration-and-operational-actions.md
  Final-B.5 TRP outbound Copy URL / Rotate URL / export controls — Not started
  Final-B.6 Integrated acceptance, regression and documentation closure — Not started
