  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/70 bg-background/85 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
        <Link aria-label={messages.navigation.homeAriaLabel} className="group flex items-center gap-3" href="/">
        ...
        <nav aria-label={messages.navigation.mainAriaLabel} className="hidden items-center gap-7 md:flex">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button asChild className="rounded-full md:hidden" size="sm">
            <Link href="#alojamientos">{messages.common.reserve}</Link>
          </Button>
        </div>
      </div>
    </header>
