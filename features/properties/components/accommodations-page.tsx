    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section className="pb-20">
          <div className="mx-auto grid max-w-7xl items-stretch gap-6 px-6 lg:grid-cols-3 lg:px-8">
            {accommodations.map((accommodation) => (
              <Card
                className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border-border/70 bg-card shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl"
